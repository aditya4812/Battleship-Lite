...
public abstract class Ship {
	 ...
	 * 
	 * @param type the string of the ship type
	 */
	...
	/**
	 * getHitCount - A method that returns the number of times the ship has been hit
	 * 
	...
	/**
	 * sunkMessage - A method that returns a message that is unique to each ship,
	 * the message is displayed when the ship has been sunk
	 * 
	 * @return sunkMessage - the message tellin the player when the ship has been
	 *         sunk
	 */
